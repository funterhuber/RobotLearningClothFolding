...
class DiffusionConfig(PreTrainedConfig):
    ...
    vision_backbone_lr: float | None = None
    # Unet.
    ...
    def __post_init__(self):
        ...
        if not self.vision_backbone.startswith("resnet") and not self.vision_backbone.startswith("dinov3"):
            raise ValueError(
                f"`vision_backbone` must be one of the ResNet or DINOv3 variants. Got {self.vision_backbone}."
            )
